							...
							<div class="card card-chart">
								...
								<div class="card-body">
                                    <form action="{{url('submit_application')}}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="card-header" id="head" style="background-color: ">
                                    ...
                                    <div class="card-body" style="background-color:">
                                            <div class="row">              
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <select name="school_name" class="form-control <?php echo ($errors->first('school_name')) ? 'border border-danger' : '';?>" id="">
